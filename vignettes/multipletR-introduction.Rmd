...
The contrast with Cell Ranger is the key point. In this PDX sample these thresholds label many
predominantly single-species barcodes as multiplets,
...
if (requireNamespace("SingleCellExperiment", quietly = TRUE) &&
  ...
  print(table(sce$multipletR_class))
